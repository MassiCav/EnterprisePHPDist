...
namespace DAL\Infrastructure\Serialization;

use DAL\EventSourcing\Domain\DomainEvent;
use DAL\Infrastructure\Serialization\Exception\DomainEventDeserializationError;
 ...
 */
final class RequestArrayDeserializer
{
    /** 
